...
class ControleurAdminCommande extends ControleurAdmin {
    ...
    public function ajouter() {    
        ...
        $this->rediriger('Adminaccueil', 'lire/' . $idCommande);
    }
    ...
    public function modifyProduitCommande() {
        ...
        if ($validation_quantite && $qte > 0) {
            ...
            $this->rediriger('Adminaccueil', 'lire/' . $produitCommandeObj['commande_id']);
        } else {
            $this->requete->getSession()->setAttribut('erreur', 'quantite');
            
            $this->rediriger('Admincommande', 'modifier/' . $idProduitCommande);
        }
    }
